...
public class EmployeeSaveDTO {
    ...
    public EmployeeSaveDTO(String name, String email, String phone_number, String job_title, double salary, double productivity_score, double quality_of_work_score, double attendance_score) {
    ...
    public String toString() {
        return "EmployeeSaveDTO{" +
                ...
                ", quality_of_work_score=" + quality_of_work_score +
